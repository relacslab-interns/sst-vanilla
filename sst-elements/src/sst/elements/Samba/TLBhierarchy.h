...
namespace SambaComponent{
    ...
    class TLBhierarchy : public ComponentExtension
    {
        ...
        void setPageTablePointers(  Address_t * cr3, 
                                    ...
                                    std::set<Address_t> * gb,  
                                    std::set<Address_t> * mb,  
                                    std::set<Address_t> * kb, 
                                    std::set<Address_t> * pr, 
                                    int *cr3I, 
                                    std::set<Address_t> *pf_pgd,
                                    std::set<Address_t> *pf_pud,  
                                    std::set<Address_t> *pf_pmd, 
                                    std::set<Address_t> * pf_pte)
        {
                        CR3 = cr3;
                        PGD = pgd;
                        PUD = pud;
